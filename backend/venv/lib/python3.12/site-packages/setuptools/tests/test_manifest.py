...
class TestManifestTest(TempDirTestCase):
    def setup_method(self, method):
        ...
        os.mkdir(static)
        for fname in ['app.cjs', 'app.cjs.map', 'app.css', 'app.css.map']:
    ...
    def test_include_multiple(self):
        ...
        files = default_files | set([
            ml('app/a.txt'),
            ml('app/b.txt'),
            ml('app/static/app.cjs'),
            ml('app/static/app.cjs.map'),
    ...
    def test_graft_global_exclude(self):
        ...
        files = default_files | set([ml('app/static/app.cjs'), ml('app/static/app.css')])
        assert files == self.get_files()
